...
/* package s-interpreter-0.1.0.0 */
#ifndef VERSION_s_interpreter
#define VERSION_s_interpreter "0.1.0.0"
#endif /* VERSION_s_interpreter */
#ifndef MIN_VERSION_s_interpreter
#define MIN_VERSION_s_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_s_interpreter */
...
#define CURRENT_PACKAGE_KEY "s-interpreter-0.1.0.0-KllsoN5vXoHDJw2JXlYInq-s-interpreter-lib"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "s-interpreter-0.1.0.0-KllsoN5vXoHDJw2JXlYInq-s-interpreter-lib"
